...
app.post("/api/login/student", (req, res) =>  {
    ...
    var userPassword = req.body.userPassword;
    const chkUser = async () =>{
        const q = `select name, roll, roomNo, email, personalContact, parentsContact, mentor from students where email = '${userEmail}' and password = '${userPassword}' and approved = true;`
